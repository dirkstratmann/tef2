...
def main(argv):
	...
	if helpPrint:
		...
		print "    -help                 This help"
                ...
                print ""
                print "Examples:"
                print "    TEF2 -pdbFile 1pyo.pdb -out myOUTPUT"
                print "    TEF2 -pdb input_examples/ -out myOUTPUT"
                print "    TEF2 -pdb input_examples/ -out myOUTPUT -subdir"
                print ""
		sys.exit()
